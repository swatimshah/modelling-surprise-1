...
frame_eeg = loadtxt('E:\\recording-car\\swati_time_synced_signals_with_frames.csv', delimiter=',', skiprows=1)
...
savetxt("swati_total_epochs_20.csv", total_epochs, delimiter=",")
